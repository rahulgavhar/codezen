...
router.get('/:contestId/replay', contestsController.getContestReplayByUserProblem);
router.post('/:contestId/replay/init', contestsController.initContestReplay);
router.post('/:contestId/replay/:timelineId/events', contestsController.appendContestReplayEvents);
router.post('/:contestId/replay/:timelineId/finalize', contestsController.finalizeContestReplay);
router.get('/:contestId/replay/:timelineId', contestsController.getContestReplay);
